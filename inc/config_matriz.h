...
void define_numero(char numero, PIO pio, uint sm){
    ...
    {
    case '0':
        desenho(desenho0, valorLed, pio, sm, 0.0, 0.0, 0.0); // desenho do número 0
        break;
    case '1':
        desenho(desenho1, valorLed, pio, sm, 0.0, 0.0, 0.0); // desenho do número 1
        break;
    case '2':
        desenho(desenho2, valorLed, pio, sm, 0.0, 0.0, 0.0); // desenho do número 2
        break;
    case '3':
        desenho(desenho3, valorLed, pio, sm, 0.0, 0.0, 0.0); // desenho do número 3
        break;

    case '4':
        desenho(desenho4, valorLed, pio, sm, 0.0, 0.0, 1.0); // desenho do número 3
        break;

    case '5':
        desenho(desenho5, valorLed, pio, sm, 0.0, 0.0, 1.0); // desenho do número 3
        break;

    case '6':
        desenho(desenho6, valorLed, pio, sm, 0.0, 0.0, 1.0); // desenho do número 3
        break;
    }
};
